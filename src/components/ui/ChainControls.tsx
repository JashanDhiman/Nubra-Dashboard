  ...
  return (
    <div className="flex items-center gap-3 px-4 py-2 bg-surface-2 border-b border-border flex-wrap">
      ...
      <div className="flex items-center gap-2">
        <span className="text-[10px] font-mono text-text-muted uppercase tracking-wider">Strikes</span>
      ...
      {/* Greeks toggle */}
      <div className="flex items-center gap-2">
        <span className="text-[10px] font-mono text-text-muted uppercase tracking-wider">Greeks</span>
        <button
      ...
      {/* Market Depth toggle */}
      <div className="flex items-center gap-2">
        <span className="text-[10px] font-mono text-text-muted uppercase tracking-wider">Depth</span>
        <button
